...
addArchRThreads(12)
# read files
setwd('~/yuzhao1/work/pouch_atac2/dataset/gut_2kmin_6TSS_DoubletRatio2/')
...
# saveArchRProject(ArchRProj = proj, load = T)
#
# png('~/yuzhao1/work/final_RC2atac/preprocess/plots/umap_res1.5.png',width = 2600, height = 3000,res = 300)
...
# dev.off()
# 
# png('~/yuzhao1/work/final_RC2atac/preprocess/plots/umap_res2.5.png',width = 2600, height = 3000,res = 300)
# df <- data.frame(proj@cellColData)
# df$embedding1 <- proj@embeddings$Harmony_UMAP$df$`Harmony#UMAP_Dimension_1`
# df$embedding2 <- proj@embeddings$Harmony_UMAP$df$`Harmony#UMAP_Dimension_2`
...
# dev.off()
# 
# png('~/yuzhao1/work/final_RC2atac/preprocess/plots/umap_res5.png',width = 2600, height = 3000,res = 300)
# df <- data.frame(proj@cellColData)
# df$embedding1 <- proj@embeddings$Harmony_UMAP$df$`Harmony#UMAP_Dimension_1`
# df$embedding2 <- proj@embeddings$Harmony_UMAP$df$`Harmony#UMAP_Dimension_2`
...
#   groupList = groupList,
#   groupRNA = "lineage",
#   nameCell = "predictedCell_lineage_Co_sample",
#   nameGroup = "predictedGroup_lineage_Co_sample",
#   nameScore = "predictedScore_lineage_Co_sample",
#   sampleCellsATAC = 10000,
#   sampleCellsRNA = 10000,
#   dimsToUse = 1:50,
#   embeddingATAC = df_atac,
...
gene <- c('CD3D', 'XBP1', 'PTPRC', 'LGR5', 'EPCAM', unlist(gca.epithelial.markers), unlist(gca.lineage.markers))  %>% unique()
...
# saveArchRProject(ArchRProj = proj, load = T)
# 
# saveRDS(all.gsm, '~/yuzhao1/work/pouch_atac2/R/preprocess/rds/all.gsm_imputed.rds')



# ###### Section4: split lineages by res5 (ref: constrained predicted) #######
# proj$lineage <- 'epithelial'
# proj$lineage[which(proj$Harmony_Clusters_res5 %in% paste0('C', c(45,51,52,53,54,55,56,57,58,59)))] <- 'tcell'
# proj$lineage[which(proj$Harmony_Clusters_res5 %in% paste0('C', c(60,61,62,63,64,65,66,67)))] <- 'bcell'
# proj$lineage[which(proj$Harmony_Clusters_res5 %in% paste0('C', c(46,49,50)))] <- 'others'
# proj$lineage[which(proj$Harmony_Clusters_res5 %in% paste0('C', c(42,43,47,48)))] <- 'myeloid'
# saveArchRProject(ArchRProj = proj, load = T)
# 
# 
# idxPass <- which(proj$lineage == 'epithelial')
# cellsPass <- proj$cellNames[idxPass]
# proj.epithelial <- subsetArchRProject(
#   ArchRProj = proj,
#   cells = cellsPass,
#   outputDirectory = "~/yuzhao1/work/final_RC2atac/dataset/gut_2kmin_6TSS_DoubletRatio2_epithelial",
#   dropCells = TRUE,
#   logFile = NULL,
#   threads = getArchRThreads(),
#   force = T
...
# 
# 
# idxPass <- which(proj$lineage == 'tcell')
# cellsPass <- proj$cellNames[idxPass]
# proj.tcell <- subsetArchRProject(
#   ArchRProj = proj,
#   cells = cellsPass,
#   outputDirectory = "~/yuzhao1/work/final_RC2atac/dataset/gut_2kmin_6TSS_DoubletRatio2_tcell",
#   dropCells = TRUE,
#   logFile = NULL,
#   threads = getArchRThreads(),
#   force = T
...
# 
# 
# idxPass <- which(proj$lineage == 'bcell')
# cellsPass <- proj$cellNames[idxPass]
# proj.bcell <- subsetArchRProject(
#   ArchRProj = proj,
#   cells = cellsPass,
#   outputDirectory = "~/yuzhao1/work/final_RC2atac/dataset/gut_2kmin_6TSS_DoubletRatio2_bcell",
#   dropCells = TRUE,
#   logFile = NULL,
#   threads = getArchRThreads(),
#   force = T
...
# 
# 
# idxPass <- which(proj$lineage == 'myeloid')
# cellsPass <- proj$cellNames[idxPass]
# proj.myeloid <- subsetArchRProject(
#   ArchRProj = proj,
#   cells = cellsPass,
#   outputDirectory = "~/yuzhao1/work/final_RC2atac/dataset/gut_2kmin_6TSS_DoubletRatio2_myeloid",
#   dropCells = TRUE,
#   logFile = NULL,
#   threads = getArchRThreads(),
#   force = T
...
# 
# 
idxPass <- which(proj$lineage == 'others')
cellsPass <- proj$cellNames[idxPass]
proj.others <- subsetArchRProject(
  ArchRProj = proj,
  cells = cellsPass,
  outputDirectory = "~/yuzhao1/work/final_RC2atac/dataset/gut_2kmin_6TSS_DoubletRatio2_others",
  dropCells = TRUE,
  logFile = NULL,
  threads = getArchRThreads(),
  force = T
