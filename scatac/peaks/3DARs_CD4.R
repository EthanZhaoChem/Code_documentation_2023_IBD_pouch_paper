...
# ############################ 0, summary ###############################
saveRDS(DARs, '~/yuzhao1/work/final_RC2atac/peaks/3DARs/DARs_CD4T.rds')
saveRDS(DARs_significant, '~/yuzhao1/work/final_RC2atac/peaks/3DARs/DARs_significant_CD4T.rds')
saveRDS(motif_stats, '~/yuzhao1/work/final_RC2atac/peaks/3DARs/motif_stats_CD4T.rds')

# DARs <- readRDS('~/yuzhao1/work/final_RC2atac/peaks/3DARs/DARs_CD4T.rds')
# DARs_significant <- readRDS('~/yuzhao1/work/final_RC2atac/peaks/3DARs/DARs_significant_CD4T.rds')
# motif_stats <- readRDS('~/yuzhao1/work/final_RC2atac/peaks/3DARs/motif_stats_CD4T.rds')
