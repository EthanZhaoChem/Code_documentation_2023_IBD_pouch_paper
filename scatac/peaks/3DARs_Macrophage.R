...
############################ 1. Macrophage: AC vs TI ###############################
temp_lineage <- 'myeloid'
contrast_name <- 'Macrophage_ACvsTI'
group.1 <- "Macrophage-AC"
group.2 <- "Macrophage-TI"
...
############################ 2. Macrophage: POU vs PP ###############################
temp_lineage <- 'myeloid'
contrast_name <- 'Macrophage_POUvsPP'
group.1 <- "Macrophage-POU"
group.2 <- "Macrophage-PP"
annotation_group <- "anno1.loc"
cutoff_FDR <- 0.01 # cutoff is for peak selection, cutoffs for motifs are specificied in the text
cutoff_Log2FC <- 1
...
# ############################ 0, summary ###############################
saveRDS(DARs, '~/yuzhao1/work/final_RC2atac/peaks/3DARs/DARs_Macrophage.rds')
saveRDS(DARs_significant, '~/yuzhao1/work/final_RC2atac/peaks/3DARs/DARs_significant_Macrophage.rds')
saveRDS(motif_stats, '~/yuzhao1/work/final_RC2atac/peaks/3DARs/motif_stats_Macrophage.rds')

# DARs <- readRDS('~/yuzhao1/work/final_RC2atac/peaks/3DARs/DARs_Macrophage.rds')
# DARs_significant <- readRDS('~/yuzhao1/work/final_RC2atac/peaks/3DARs/DARs_significant_Macrophage.rds')
# motif_stats <- readRDS('~/yuzhao1/work/final_RC2atac/peaks/3DARs/motif_stats_Macrophage.rds')
