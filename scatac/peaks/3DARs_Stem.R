...
# DARs_significant <- readRDS('~/yuzhao1/work/final_RC2atac/peaks/3DARs/DARs_significant_Stem.rds')
# motif_stats <- readRDS('~/yuzhao1/work/final_RC2atac/peaks/3DARs/motif_stats_Stem.rds')
...
# calculation
proj <- paste0('proj_', temp_lineage) %>% as.name(.) %>% eval(.)
proj$anno1.loc[which(proj$anno1.loc %in% c("Stem-POU1", "Stem-POU2"))] <- "Stem-POU"
...
# ############################ 0, summary ###############################
saveRDS(DARs, '~/yuzhao1/work/final_RC2atac/peaks/3DARs/DARs_Stem.rds')
saveRDS(DARs_significant, '~/yuzhao1/work/final_RC2atac/peaks/3DARs/DARs_significant_Stem.rds')
saveRDS(motif_stats, '~/yuzhao1/work/final_RC2atac/peaks/3DARs/motif_stats_Stem.rds')
