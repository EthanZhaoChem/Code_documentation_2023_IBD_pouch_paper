...
metadata.original <- metadata.original[metadata.original$anno1.sub %in% c("POU_EC1", "POU_EC2"),]
...
results <- modelfit
saveRDS(results ,'~/yuzhao1/work/final_RC2atac/dar_great/rds/da_results_POU_EC2vsPOU_EC1.rds')
