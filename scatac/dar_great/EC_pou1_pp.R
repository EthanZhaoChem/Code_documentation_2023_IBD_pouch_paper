...
metadata.original <- metadata.original[metadata.original$anno1.sub %in% c("PP_EC", "POU_EC1"),]
...
results <- modelfit
saveRDS(results ,'~/yuzhao1/work/final_RC2atac/dar_great/rds/da_results_POU1vsPP.rds')
