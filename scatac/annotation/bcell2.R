...
png('~/yuzhao1/work/final_RC2atac/annotation/plots/bcell/umap_anno1.png',width = 2600, height = 3000,res = 300)
...
png('~/yuzhao1/work/final_RC2atac/annotation/plots/bcell/umap_anno1_loc.png',width = 5000, height = 5200,res = 300)
df <- data.frame(proj@cellColData)
df$embedding1 <- proj@embeddings$Harmony_UMAP$df$`Harmony#UMAP_Dimension_1`
df$embedding2 <- proj@embeddings$Harmony_UMAP$df$`Harmony#UMAP_Dimension_2`
df$cluster_name <- proj$anno1
...
png('~/yuzhao1/work/final_RC2atac/annotation/plots/bcell/umap_anno1_Co_lineage.png',width = 2600, height = 3000,res = 300)
df <- data.frame(proj@cellColData)
df$embedding1 <- proj@embeddings$Harmony_UMAP$df$`Harmony#UMAP_Dimension_1`
df$embedding2 <- proj@embeddings$Harmony_UMAP$df$`Harmony#UMAP_Dimension_2`
