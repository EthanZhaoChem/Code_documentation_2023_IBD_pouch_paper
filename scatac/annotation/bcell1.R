...
# read files
proj <- loadArchRProject(path = "~/yuzhao1/work/final_RC2atac/dataset/gut_2kmin_6TSS_DoubletRatio2_bcell/")
...
# saveArchRProject(ArchRProj = proj, load = T)
# 
# png('~/yuzhao1/work/final_RC2atac/annotation/plots/bcell/umap_res1.5.png',width = 2600, height = 3000,res = 300)
...
# dev.off()
# 
# png('~/yuzhao1/work/final_RC2atac/annotation/plots/bcell/umap_res2.5.png',width = 2600, height = 3000,res = 300)
# df <- data.frame(proj@cellColData)
# df$embedding1 <- proj@embeddings$Harmony_UMAP$df$`Harmony#UMAP_Dimension_1`
# df$embedding2 <- proj@embeddings$Harmony_UMAP$df$`Harmony#UMAP_Dimension_2`
...
# dev.off()
# 
# png('~/yuzhao1/work/final_RC2atac/annotation/plots/bcell/umap_res5.png',width = 2600, height = 3000,res = 300)
# df <- data.frame(proj@cellColData)
# df$embedding1 <- proj@embeddings$Harmony_UMAP$df$`Harmony#UMAP_Dimension_1`
# df$embedding2 <- proj@embeddings$Harmony_UMAP$df$`Harmony#UMAP_Dimension_2`
...
png('~/yuzhao1/work/final_RC2atac/annotation/plots/bcell/umap_anno1_un.png',width = 2600, height = 3000,res = 300)
df <- data.frame(proj@cellColData)
df$embedding1 <- proj@embeddings$Harmony_UMAP$df$`Harmony#UMAP_Dimension_1`
df$embedding2 <- proj@embeddings$Harmony_UMAP$df$`Harmony#UMAP_Dimension_2`
...
png('~/yuzhao1/work/final_RC2atac/annotation/plots/bcell/umap_lineage_un.png',width = 2600, height = 3000,res = 300)
df <- data.frame(proj@cellColData)
df$embedding1 <- proj@embeddings$Harmony_UMAP$df$`Harmony#UMAP_Dimension_1`
df$embedding2 <- proj@embeddings$Harmony_UMAP$df$`Harmony#UMAP_Dimension_2`
df$cluster_name <- proj$predictedGroup_lineage_un
plot_df_umap_custom(df, show.label = 'name')
dev.off()
...
# idxPass <- which(proj$predictedGroup_lineage_un %in% c('bcell'))
# cellsPass <- proj$cellNames[idxPass]
# proj.filtered <- subsetArchRProject(
#   ArchRProj = proj,
#   cells = cellsPass,
#   outputDirectory = "~/yuzhao1/work/final_RC2atac/dataset/gut_2kmin_6TSS_DoubletRatio2_bcell_filtered",
#   dropCells = TRUE,
#   logFile = NULL,
