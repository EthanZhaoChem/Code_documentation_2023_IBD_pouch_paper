...
# please choose again the TFs to highlight
labels <- rna_deg_markers_ec_tfs
# labels <- genes.show
labels.idx <- match(labels, rownames(Average.expression.mtx))

pdf(paste0(out.dir, plot.title , '_location_dense.pdf'), width = 5, height = 5)
...
p2 <- Heatmap(Average.expression.mtx.patients, col = rc2_rna_heatmap_colors_gradient1, 
...
pdf(paste0(out.dir, plot.title , '_sample_dense.pdf'), width = 8, height = 6, pointsize = 1)
print(p2)
dev.off()
```
