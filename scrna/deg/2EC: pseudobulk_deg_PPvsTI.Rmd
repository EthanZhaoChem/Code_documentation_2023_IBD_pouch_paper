...
```{r}
seurat <- subset(seurat, cells = Cells(seurat)[seurat$anno1 %in% c('EC-PP', 'EC-TI')])
...
saveRDS(de_results ,'~/gca/yuzhao1/work/final_RC2rna/deg/epithelial/ec/pseudobulk/de_results_TIvsPP_bulk.rds')
```
...
saveRDS(resDf ,'~/gca/yuzhao1/work/final_RC2rna/deg/epithelial/ec/pseudobulk/resDf_TIvsPP_bulk.rds')
```
