...
```{r}
groupToTest <- 'Stem'
seurat <- subset(epithelial, anno1 == groupToTest)
...
```{r}
out.dir <- '~/yuzhao1/work/final_RC2rna/deg/epithelial/stem/'
```
...
<!-- ### pseudo-bulk test POU vs PP, can't reach enough adj-p value, because each bulk is small -->
...
<!-- saveRDS(resDf , paste0(out.dir, 'pathways_pseudobulk_.rds')) -->
<!-- ``` -->
