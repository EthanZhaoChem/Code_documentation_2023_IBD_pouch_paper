...
```{r}
seurat <- subset(seurat, cells = Cells(seurat)[seurat$anno1 %in% c('Goblet-POU2', 'Goblet-AC')])
...
```{r}
de_results[["Goblet"]] = eBayes(de_results[["Goblet"]])
saveRDS(de_results ,'~/gca/yuzhao1/work/final_RC2rna/deg/epithelial/goblet/de_results_pou2vsAC_bulk.rds')
```
...
saveRDS(resDf ,'~/gca/yuzhao1/work/final_RC2rna/deg/epithelial/goblet/pathway_pou2vsAC_bulk.rds')
```
