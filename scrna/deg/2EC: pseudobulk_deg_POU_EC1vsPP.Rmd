...
```{r}
seurat <- subset(seurat, cells = Cells(seurat)[seurat$anno1 %in% c('EC-POU1', 'EC-PP')])
...
```{r}
saveRDS(de_results ,'~/gca/yuzhao1/work/final_RC2rna/deg/epithelial/ec/pseudobulk/de_results_PP_ECvsPOU_EC1.rds')
```
...
saveRDS(resDf ,'~/gca/yuzhao1/work/final_RC2rna/deg/epithelial/ec/pseudobulk/resDf_PP_ECvsPOU_EC1.rds')
```
