...
```{r}
seurat <- subset(epithelial, cells = Cells(epithelial)[epithelial$anno2 %in% c('Goblet1', 'Goblet2')])
...
```{r}
saveRDS(de_results ,'~/gca/yuzhao1/work/final_RC2rna/deg/epithelial/goblet/de_results_Goblet2vs1_bulk.rds')
```
...
fclist <- topTable(de_results[["Goblet"]],
         coef="anno1.subGoblet2",
         p.value = 0.05,
         sort.by = 'logFC',
         number = 1000000)
...
saveRDS(resDf ,'~/gca/yuzhao1/work/final_RC2rna/deg/epithelial/goblet/pathway_Goblet2vs1_bulk.rds')
```

```{r}
resDf <- readRDS('~/gca/yuzhao1/work/final_RC2rna/deg/epithelial/goblet/pathway_Goblet2vs1_bulk.rds')
View(resDf)
```
