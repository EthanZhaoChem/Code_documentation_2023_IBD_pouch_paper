...
df$ethnicity <- mapvalues(df$patient, meta2$patient, meta2$Race, warn_missing = F)
```


```{r}
FilePath.pdf1 <- paste0(out.dir, 'plots/union_AllGenes_PC12.pdf') 
...
```{r}
FilePath.pdf1 <- paste0(out.dir, 'plots/union_AllGenes_PC34.pdf') 
...
```{r}
FilePath.pdf1 <- paste0(out.dir, 'plots/union_AllGenes_PC56.pdf') 
...
```{r}
FilePath.pdf1 <- paste0(out.dir, 'plots/union_AllGenes_PC78.pdf') 
