...
for(numCluster in 3:10){
  ...
  pdf(paste0(out.dir, 'domain_deg_heatmap/spatial_domain_', numCluster, '_deg_heatmap_withLegend.pdf'), width = 6, height = numCluster * 2)
  p2 <- DoHeatmap(seurat, features = top10$gene)
  print(p2)
  dev.off()
}
